...
export default function GlobalAIPresence() {
  ...
  return (
    <aside
      ...
      className="fixed inset-y-3 right-3 z-[70] flex w-[min(460px,calc(100vw-24px))] flex-col overflow-hidden rounded-[28px] border border-white/10 bg-[#080a0f]/95 text-white shadow-[0_30px_120px_rgba(0,0,0,0.72)] backdrop-blur-2xl sm:inset-y-4 sm:right-4"
    >
