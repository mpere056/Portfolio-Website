...
more-info:
  ...
  - "It was originally just meant to output non distinct groups of a given size. I later realized I could also input a sudoku puzzle into this and it will find all the possible solutions for it."
tech:
  - "C++"
media:
  - type: "image"
