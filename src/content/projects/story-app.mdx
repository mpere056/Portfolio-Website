...
more-info:
  - "Designed the UX flow and coded the entire Flutter front-end."
  ...
  - "Hands-on crash course that helped me learn mobile development and AI integration with prompt-chaining."
tech:
  - "Flutter (Dart)"
  - "OpenAI API"
