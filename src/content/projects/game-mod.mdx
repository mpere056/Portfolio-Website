...
more-info:
  ...
  - "I created a number of random things in this mod, like a new PvP gamemode where people could shoot colorful exploding balls at each other. The balls were bouncy and it was a whimsical but competitive gamemode."
  - "I also created a login system so people could add each other as friends."
tech:
  - "C#"
  - "DNSpy"
  - "Unity"
