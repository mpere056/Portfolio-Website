...
media:
  type: "image"
  src: "/images/aottg-mod.gif"
---
I first started playing an indie game called Attack on Titan Tribute Game in 2013.
Around the end of the school semester with my programming course, I found out that the Unity games could be modded through using .NET decompilers like DNSpy.
Now realizing the entire game was editable, this opened up a whole new programming playground for me.
