...
const DEFAULTS: Readonly<Record<PortfolioEnvironment, FeatureFlags>> = {
  development: { ...ALL_DISABLED, experienceFoundation: true, firstNote: true, guidedTour: true, globalAI: true },
  preview: { ...ALL_DISABLED, experienceFoundation: true, firstNote: true, guidedTour: true, globalAI: true },
