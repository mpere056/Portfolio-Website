...
| `EV-ART-16-14` | `ART-16` | `CAP-ART-017`, `CAP-ART-019` | implementation-test / build / production / browser-flow / visual-review | candidate | Commits through `406634a`: farther-right camera with `0.18` bounded pointer travel, river-safe GLTF-grounded pearl piano, continuous foreground grass, quieter `0.52` ambient wind, damped terrain-local cursor wake with a softer `4.2`-unit falloff, extended/tapered valley water, and frustum-safe ridges; 240 tests, TypeScript, lint, content validation, and the 40-route build pass | 2026-07-28 | `ART-16.md` |
