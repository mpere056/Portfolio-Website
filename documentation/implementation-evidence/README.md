...
| `EV-ART-16-17` | `ART-16` | `CAP-ART-017` | implementation-test / build / production / browser-flow / visual-review | candidate | The live no-index 10-slide deck now presents Mark's programming/career arc from game systems through modding, community scale, CRA, degree completion, professional software, Dreamlife, and FirePower Capital before an AI-in-business handoff; route-specific visuals, navigation, fullscreen, reduced motion, chrome suppression, focused tests, the 41-route build, and representative built-browser review pass | 2026-07-28 | `ART-16.md` |
