...
| `EV-ART-16-04` | `ART-16` | `CAP-ART-017`, `CAP-ART-019` | implementation-test / production | candidate | Commit `cd0b673`, Production `dpl_BGi4QF3NKGdn9UBR6vRSnC79vGiA`: particle-piano riverside overlook uses one Canvas, one point draw, moving water, instanced grass/trees, layered hills, sky, and clouds; 237 tests, build, and smoke pass; normal-browser visual review pending | 2026-07-26 | `ART-16.md` |
