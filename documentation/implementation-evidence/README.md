...
| `EV-ART-16-05` | `ART-16` | `CAP-ART-017`, `CAP-ART-019` | implementation-test / visual-review | candidate | Local elevated-valley candidate explicitly separates the particle-piano plateau, steep descent, lateral valley-floor river, opposite hillside, and low horizon; lint, TypeScript, 237 tests, content validation, and 40-route build pass; deployment and review pending | 2026-07-27 | `ART-16.md` |
