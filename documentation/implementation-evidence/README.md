...
| `EV-ART-16-17` | `ART-16` | `CAP-ART-017` | implementation-test / build / production / browser-flow / visual-review | candidate | Commits `6477e5c` and `78c19ee` replace the staging room with a live no-index 10-slide About deck, route-specific animated diagrams, direct/keyboard/swipe navigation, fullscreen, reduced motion, and presentation-only chrome suppression; 243 assertions pass across aggregate and isolated reruns, and six representative slides pass built-browser review | 2026-07-28 | `ART-16.md` |
