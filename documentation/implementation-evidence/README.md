...
| `EV-ART-16-01` | `ART-16` | `CAP-ART-017`, `CAP-EXP-015` | browser-flow | candidate | Production no-index five-anchor neutral shell, shared Home piano, deterministic selection/return, 232 tests, 40-page build, local one-screen review, and live route smoke | 2026-07-24 | `ART-16.md` |
