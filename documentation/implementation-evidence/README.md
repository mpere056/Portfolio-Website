...
| `EV-ART-16-14` | `ART-16` | `CAP-ART-017`, `CAP-ART-019` | implementation-test / build / production / browser-flow / visual-review | candidate | Commits `48ef8ba` and `5718cd8`: farther-right camera with slight left yaw, river-safe GLTF-grounded pearl piano, continuous unpatched grass, extended/tapered valley water, and frustum-safe ridges; 240 tests, TypeScript, lint, content validation, 40-route build, and local tall-viewport review pass | 2026-07-28 | `ART-16.md` |
