...
| `EV-ART-16-14` | `ART-16` | `CAP-ART-017`, `CAP-ART-019` | implementation-test / build / production / browser-flow / visual-review | candidate | Commits through `f008907`: farther-right camera with slight left yaw, river-safe GLTF-grounded pearl piano, continuous foreground grass, quieter `0.68` ambient wind, terrain-local cursor bending, extended/tapered valley water, and frustum-safe ridges; 240 tests, TypeScript, lint, content validation, 40-route build, and local tall-viewport review pass | 2026-07-28 | `ART-16.md` |
