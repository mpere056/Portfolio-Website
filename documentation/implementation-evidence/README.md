...
| `EV-ART-16-09` | `ART-16` | candidate | `ART-16.md` |
...
| `EV-ART-16-09` | `ART-16` | `CAP-ART-017`, `CAP-ART-019` | implementation-test / production / browser-flow / visual-review | candidate | Commit `98a1dca`, Production `dpl_4EQ9StMdGVpuuJ9LxgjdnMypLvxw`: shared terrain exclusions keep trees off water and ravine walls; warmer grass, two-tone canopies, fuller clouds, and recovered saturation pass 238 tests, TypeScript, lint, 40-route build, and local visual review | 2026-07-27 | `ART-16.md` |
