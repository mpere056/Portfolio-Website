...
| Automated evidence | All 57 test files / 240 tests, TypeScript, focused ESLint, content validation, and the clean 40-route Production build pass. Tests bind the farther-right camera, river-safe high-meadow piano coordinate, geometry-aware grounding, non-saturated particle treatment, continuous valley geometry, hidden ridge edges, tapered river endpoint, and foreground grass extent. |
...
| Production evidence | Commits `48ef8ba`, `5718cd8`, and `223d226` are pushed to `main` for Git-connected Production at `/home-world-proof`. |
