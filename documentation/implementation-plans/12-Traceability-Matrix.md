...
| Phase 4 Remaining flagships | functionality live; `ART-01` and `ART-03` through `ART-06` implemented candidates; creative `QA-02` reopened | Three distinct flagship experiences, lifecycle-driven historical depth, canonical routes, connected state, AI migration, keyframes, original matter, and supporting-route translations are implemented; public verification and Mark creative acceptance remain |
