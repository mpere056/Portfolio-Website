...
| Phase 2 Exploration shell | `QA-01`, `EXP-02` to `EXP-06`, `AI-02`, `AI-03`, `KG-05`, `KG-06` | Accepted locally as one shell through `51b2e7d`; aggregate deployment evidence is `WI-QA-01-02`; final disturbances remain with `EXP-07`/`LPS-04` in Phase 6 |
