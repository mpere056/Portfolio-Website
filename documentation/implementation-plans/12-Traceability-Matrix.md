...
| Phase 4 Remaining flagships | functionality live; `ART-01`, `ART-03`, `ART-04`, and creative `QA-02` reopened | Three distinct flagship experiences, lifecycle-driven historical depth, canonical routes, connected state, AI migration, and project-domain behavior remain valid; visual reference coverage, real keyframes, original matter, and Mark creative acceptance remain |
