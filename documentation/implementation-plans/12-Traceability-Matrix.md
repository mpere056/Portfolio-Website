...
| Phase 4 Remaining flagships | implementation complete; `ART-03` and creative re-review of `QA-02` in review | Three distinct flagship experiences, lifecycle-driven historical depth, canonical routes, connected state, AI migration, and project-domain dialects pass the local release-candidate gate; deployment and Mark aesthetic acceptance remain |
