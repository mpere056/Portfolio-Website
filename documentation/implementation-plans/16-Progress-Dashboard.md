...
| --- | --- | --- | --- |
| 2026-07-28 | Quieted meadow wind and added local cursor wake | `ART-16B`, `CAP-ART-017/019`, `EV-ART-16-14` | Commit `f008907` reduces ambient blade sway to `0.68` and adds a terrain-projected cursor response that bends only nearby grass within a `3.6`-unit falloff, then releases smoothly. The shader-only change preserves the 220,000-blade and single-draw budgets; TypeScript, focused lint, 240 tests, content validation, clean 40-route build, and local idle visual review pass. |
