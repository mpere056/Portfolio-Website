...
| `CAP-KG-008`, `CAP-ART-017`, `CAP-ART-019` | `WI-ART-16-01` | Four-practice taxonomy remains; a finite particle-piano riverside world with explicit render/lifecycle budgets is deployed | Mark vista review and target-machine performance remain | No-index proof only; public routes unchanged | Review Checkpoint `B` revision | `EV-ART-16-03/04`; `cd0b673`; `dpl_BGi4QF3NKGdn9UBR6vRSnC79vGiA`; 237 tests; 40-page build |
