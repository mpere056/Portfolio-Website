...
| `O-04` Home work world | `E0` verified; Liquid Landscape through `ML5` candidate | on-track | River-safe pearl piano, seated pianist, three instruments, one-owner lifecycle, and one isolated responsive territory with adaptive calm/failure behavior are implemented | Renderer metrics, slower-device observation, and `ML6` review | Preserve neutral parity; prove one territory before full selected-world or hover work |
...
| Next | same work item | not-started | `ART-16` | Shared field, local response, and adaptive Full/Balanced/Calm/reduced/failure behavior implemented | Measure the Balanced tier on a previously laggy computer, prepare `ML6`, and stop for Mark review | 2026-07-31 |
...
| Candidate | 18 | Includes the provisional canonical Home promotion, About presentation, and private one-territory Liquid Landscape material/local-response/adaptive-runtime candidates; none is being treated as final creative acceptance |
