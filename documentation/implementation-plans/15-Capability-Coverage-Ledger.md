...
| `CAP-ART-018` | Practice-screen environmental preview and selected-state transformation | `ART-16` | `V-31`, `V-33`, `V-35`, `V-36` | `O-01`, `O-04` | 5 | `S: accepted; C: prototype-direction-accepted; A: documented; I: partial; T: candidate; Q: ML5-focused-tested; R: private-proof` | Measure and complete `ML5-ML6` before selected-world or hover expansion |
...
- Next checkpoint: capture renderer metrics and slower-device evidence for the private `ML4/ML5` candidate, then prepare `ML6`. Full selected world and hover remain blocked by `ML6` review.
