...
| Downstream | Home practice world, project routes/subdomains, About, AI doors, blogs, utility states, quality and rollout |
| Primary outputs | Cross-plan ownership, aesthetic contracts, delivery packages, surface coverage, handoff gates |
| Execution packages | `ART-01` through `ART-16` in [Work Packages](13-Execution-Work-Packages.md) |
| Capability tracking | `CAP-ART-001` through `CAP-ART-019` in [Capability Ledger](15-Capability-Coverage-Ledger.md) |
...
- **Surface dialects** translate those laws for the Home territories, each project, About depth, AI, blogs, and utility states.
...
| `05` Projects | Product truth, practice ownership, project state, interaction, evidence, route handoff | Practice project instruments and project-specific art packets | Territory reveal preserves direct project depth |
...
Earlier assignments remain the source of silhouette, composition, content, and interaction truth. `ART-12` proof outputs feed `ART-16`; route-local ambient work under `ART-13` through `ART-15` is resequenced after the Home-world gate rather than blocking it.
...
### `ART-12`: Ambient Contract, Asset Decomposition, And Bounded Proofs
...
- Retain `ART-12A-F`: baseline, mapping, asset briefs, representative production, asset approval, and accepted bounded compositor proofs.
