...
| `ART-07` | Dynamic scene contracts and Museum proof | `ART-06`, `EXP-05`, `KG-05` | Dynamic scene packet, bounded driver/lifecycle seam, Museum layer pack, and one causal independently layered response | Local and Production gates pass; sustained observation and Mark acceptance remain | implemented |
| `ART-08` | LifeInbox dynamic material transformation | `ART-07`, `PRJ-04` | Route-specific layer pack and dynamic capture, settlement, boundary, evidence, and reminder-return transformation | Product, route, fallback, test, build, and Production gates pass; sustained observation and Mark acceptance remain | implemented |
