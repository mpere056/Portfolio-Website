...
| ID | Package | Depends on | Deliverables | Exit evidence | Current status |
| --- | --- | --- | --- | --- | --- |
| `ART-01` | Direction and first keyframe selection | Accepted depth grammar, live Phase 3 audit, Mark feedback | Accepted Observatory charter plus six material studies, three Museum alternatives, and selected/reassigned production packets | Direction and inputs are implemented; route-level Mark review remains before acceptance | implemented |
...
| `ART-03` | Museum and LifeInbox remediation | `ART-01`, `ART-02`, `PRJ-04` | Replace the functional `dd11a4f` baseline with selected ecology/organism Museum and alchemical-vessel LifeInbox packets | Local and public regression/build/route checks pass; Mark review remains | implemented |
| `ART-04` | Project and archive dialect packets | `ART-03`, `LPS-03` | Rebuild Dreamlife with liquid nacre, Sudoku with diagram-organism anatomy, and historical work with painterly/specimen richness | Route-specific assets and public domains are verified; Mark review remains | implemented |
| `ART-05` | Home, About, AI, reading, and utility translation | `ART-03`, `ABT-01`, `AI-04` | Home painterly threshold; illuminated About archive; translucent AI; materially related reading; inherited support states | Supporting routes are implemented and publicly verified; Mark review remains | implemented |
| `ART-06` | Whole-portfolio coherence and production maturation | `ART-03`, `ART-04`, `ART-05`, `PRJ-05`, `PRJ-06`, `PRJ-07` | Cross-route asset registry, material, motion, darkness, reduced-motion, and asset-loading review | Local desktop matrix and build pass; public evidence and Mark acceptance remain | implemented |
| `ART-07` | Dynamic scene contracts and Museum proof | `ART-06`, `EXP-05`, `KG-05` | Dynamic scene packet, bounded driver/lifecycle seam, Museum layer pack, and one causal independently layered response | Local reducer/browser/build/calm gates pass; Preview, Production, and Mark acceptance remain | implemented |
| `ART-08` | LifeInbox dynamic material transformation | `ART-07`, `PRJ-04` | Route-specific layer pack and dynamic capture, settlement, boundary, evidence, and reminder-return transformation | Local product behavior, direct routes, semantic fallback, calm/failure, tests, build, and browser gates pass; Preview, Production, performance observation, and Mark acceptance remain | implemented |
| `ART-09` | Remaining flagship dynamic compositions | `ART-07`, `ART-08`, `PRJ-05`, `PRJ-06` | Separate Dreamlife refraction and Sudoku shared-presence scene packets, materials, and runtimes | Local causal, distinction, calm/failure, tests, build, and browser gates pass; Preview, Production, sustained performance, and Mark acceptance remain | implemented |
| `ART-10` | Supporting-route dynamic compositions | `ART-07`, `ART-09`, `ART-05`, `ABT-01`, `AI-05` | Independently reasoned Home, About, AI, and reading dynamics with restrained route-specific layer packs | Local threshold, inspected event, AI door, reading calm, fallback, distinction, 184 tests, build, and browser gates pass; Production and Mark acceptance remain | implemented |
| `ART-11` | Dynamic scene coherence and production maturation | `ART-07`, `ART-08`, `ART-09`, `ART-10` | Cross-route temporal, renderer, asset, context-loss, capability-tier, calm, and repetition review | Typed representative matrix, lifecycle correction, local aggregate, and browser gates pass; sustained observation, Production, and Mark acceptance remain | implemented |
...
| `ABT-02` | Event inspection | `ABT-01`, `EXP-02`, `AI-01`, `ART-05` | Open/close state, consequence UI, AI context | Timeline remains usable, authored, and deep links work | pending |
| `ABT-03` | Memory-room prototype | `ABT-02`, `EXP-05`, `ART-05` | One event, one object, one return transition | Keep/revise/remove decision with creative evidence | prototype |
...
| `QA-02` | First vertical-slice quality gate | `PRJ-04`; creative re-review depends on `ART-03` | Logic, browser, visual, performance, creative review | Functional evidence remains accepted; deployed creative candidate failed reference coverage and awaits a keyframe-first replacement | reopened |
