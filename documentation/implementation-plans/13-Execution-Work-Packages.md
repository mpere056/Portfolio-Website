...
| `ART-03` | Museum and LifeInbox remediation | `ART-01`, `ART-02`, `PRJ-04` | Replace the functional `dd11a4f` baseline with selected ecology/organism Museum and alchemical-vessel LifeInbox packets | Local reference-rich runtime, regression/build, and browser review pass; public verification and Mark review remain | implemented |
| `ART-04` | Project and archive dialect packets | `ART-03`, `LPS-03` | Rebuild Dreamlife with liquid nacre, Sudoku with diagram-organism anatomy, and historical work with painterly/specimen richness | Route-specific assets and deep states are implemented; public verification and Mark review remain | implemented |
| `ART-05` | Home, About, AI, reading, and utility translation | `ART-03`, `ABT-01`, `AI-04` | Home painterly threshold; illuminated About archive; translucent AI; materially related reading; inherited support states | Supporting-route implementation and local review pass; public verification and Mark review remain | implemented |
