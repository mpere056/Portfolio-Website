...
| Future Home instruments | Confirmed direction | Pianist represents About; three screens represent the three project practices. AI is cross-cutting. |
...
| 2026-07-30 | Reduce Home from four project practices to three | Confirmed by Mark; implemented in taxonomy and Home instruments | Music & Performance, Life Systems & Tools, and Play & Community remain destinations. Dreamlife moves to Life Systems; Interactive Story Generator moves to Play; AI becomes a cross-cutting capability rather than a category. | [Three-Practice Taxonomy](2026-07-30-Three-Practice-Taxonomy-Decision.md) |
