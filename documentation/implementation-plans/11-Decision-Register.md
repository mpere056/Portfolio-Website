...
| 2026-07-14 | Use canonical namespaced content IDs with explicit one-way aliases for genuine renames | Confirmed and implemented for current content; graph namespace follow-up active | Projects, timeline events, misc knowledge, and posts have stable identities; `WI-ARC-02-02` separates those from broader graph-only node identities | [Stable Content ID Decision](../implementation-baselines/2026-07-14-Stable-Content-ID-Decision.md) |
