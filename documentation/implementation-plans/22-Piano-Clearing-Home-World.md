...
- Commit `f008907` quiets idle blade wind to `0.68` and projects cursor velocity onto the terrain so nearby grass wakes directionally and then settles; the response is shader-only, local to a `3.6`-unit radius, and disabled by reduced-motion.
