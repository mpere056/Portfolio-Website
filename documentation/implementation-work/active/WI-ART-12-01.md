...
- Mark accepts the added silhouette but finds it too opaque for the particle treatment. Revision 4 reduces the body to `0.075` opacity and its wireframe to `0.006`, preserving recognition while returning visual priority to the particles.
