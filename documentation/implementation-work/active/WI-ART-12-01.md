...
- Next exact action: deploy `/projects/observatory-proof` and let Mark review the fixed-architecture, unequal-optics, current, refraction, haze, and attention balance. Technical documents are optional.
