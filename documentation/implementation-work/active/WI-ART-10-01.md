# WI-ART-10-01: Compose Supporting Routes Dynamically
...
| Requirements | `V-01`, `V-04`, `V-05`, `V-09`, `V-18`, `V-22`, `V-31`, `V-32` |
...
- [x] Home awakens only from the existing First Note phase.
- [x] About follows the inspected canonical event.
- [x] AI visualizes existing context and request state without becoming a separate assistant.
