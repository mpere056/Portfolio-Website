...
| --- | --- | --- | --- | --- | --- | --- |
| Now | `WI-ART-12-01` | in-review | `ART-12` | `ART-12A-E` complete; west ecology accepted; east observatory proof implemented locally | Deploy `/projects/observatory-proof` for Mark review; after acceptance, complete `12F` and begin bounded `12G` integration | 2026-07-21 |
