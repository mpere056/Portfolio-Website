...
| --- | --- | --- | --- | --- | --- | --- |
| Now | `WI-ART-12-01` | in-review | `ART-12` | West ecology accepted; east observatory revision 5 is live at `835b8ac` with rotating geometry, stochastic windows, and all technical gates passing | Mark reviews revision 5; after acceptance, complete `12F` and begin bounded `12G` integration | 2026-07-21 |
