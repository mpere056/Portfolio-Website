...
Revision 7 retains revision 6's fully procedural flow stack but replaces imperceptibly slow highlight drift with a human-legible directional motion contract. The cyan-gold lead carries coherent luminous bands, a comet wake, and embedded signal carriers across the stage in roughly six to eight seconds. Copper, ivory, and arch families carry their own slower fronts and carriers on distinct 13.5, 17.5, and 21 second clocks. Local attention accelerates only nearby material. The separated architecture, rotating pearl instrument, tower-only stochastic windows, 700-particle ecology, and accepted Museum attention stack remain intact.
