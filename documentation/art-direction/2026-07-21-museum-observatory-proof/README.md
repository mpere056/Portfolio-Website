...
- Revision 3 removes the static-particle source image from normal rendering and introduces four independently shaded structural plates plus three procedural particle depths. Local `1912 x 948` inspection confirms materially different idle frames, a stronger localized attention state, one-viewport geometry, and no console warnings or errors.
