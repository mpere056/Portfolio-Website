...
Revision 5 retains revision 4's separated territories and replaces the baked central lens with a true Three.js pearl instrument. Its asymmetric mineral surface, fixed scene lights, Fresnel edge, and unequal-axis rotation make volume legible without moving the surrounding lattice. Selected skyscraper windows ease independently between off, dim, and lit states on slow stochastic clocks; explicit tower zones exclude the foreground dome, podium, stairs, and ground machinery. The 700-particle ecology, procedural currents, portal, atmosphere, optical diagram, and accepted production Museum attention stack remain intact.
