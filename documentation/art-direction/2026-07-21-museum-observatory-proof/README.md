...
Revision 6 retains revision 5's separated territories, rotating Three.js pearl instrument, and tower-only stochastic windows while replacing the remaining SVG current overlay with two code-generated shader depths. The rear pass owns copper weave, ivory braid, and high arch threads. The front pass owns the cyan-gold lead stream, traveling laser-like packets, micro-wisps, and the central spectral signal. Every family has independent phase and velocity, remains alive without input, and gains energy only near attention. The 700-particle ecology, portal, atmosphere, optical diagram, and accepted production Museum attention stack remain intact.
